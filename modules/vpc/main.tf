...
# This creates a complete VPC with public and private subnets across 2 availability zones
...
# Internet Gateway (for public subnets to reach internet)
...
# VPC Flow Logs (for network traffic analysis and security)
